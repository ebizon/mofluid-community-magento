...
use Mofluid\Mofluidapi2\Api\ReviewInterface;
use Magento\Review\Model\Review;
use Magento\Review\Model\ResourceModel\Review\CollectionFactory;
class ReviewManagement implements \Mofluid\Mofluidapi2\Api\ReviewInterface
{
    /**
     * Review collection
     *
    ...
    public function getReviewsList($productId)
     {$response[] = [
        ...
        $ratingSummary = (int)$product->getRatingSummary()->getRatingSummary();
        $reviewArray = [];
