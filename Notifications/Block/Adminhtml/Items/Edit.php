 ...
 */
namespace Mofluid\Notifications\Block\Adminhtml\Items;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Mofluid_Notifications';
    ...
    {
        $item = $this->_coreRegistry->registry('current_mofluid_notifications_items');
        if ($item->getId()) {
