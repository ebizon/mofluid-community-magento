<?php
/**
 * Copyright © 2015 Push-notificationscommerce. All rights reserved.
 */
namespace Pushnotifications\MofluidPushNotifications\Model;

/**
 * MofluidPushNotifications Config model
 */
